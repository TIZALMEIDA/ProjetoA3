...
public class Lanches extends javax.swing.JFrame {
    ...
    public Lanches() {
        initComponents();
        this.setTitle("LISTA DE LANCHES");
        this.refreshTable();
    }

    public void refreshTable() {
        DB db = new DB("bancodados.db");
        db.query("SELECT * FROM lanches");
        String cols[] = { "CODIGO", "LANCHES", "VALOR", "TAMANHO" };
        String fields[] = { "codigo", "hamburguer", "valor", "tamanho" };        
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        LanchesCad cadastro = new LanchesCad(this,-1);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        DB db = new DB("bancodados.db");
        String query = "DELETE FROM lanches WHERE codigo="+codigo;
        db.execQuery(query);
        refreshTable();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String codigo = (String) table.getValueAt(linha, 0);
        System.out.println("Código :"+codigo);
        LanchesCad cadastro = new LanchesCad(this, Integer.parseInt(codigo));
        cadastro.setVisible(true);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        DB db = new DB("bancodados.db");
        db.query("SELECT * FROM lanches WHERE hamburguer LIKE '%" + nomeBuscar + "%'");
        String cols[] = { "CODIGO", "LANCHES", "VALOR", "TAMANHO" };
        String fields[] = { "codigo", "hamburguer", "valor", "tamanho" };        
        TableRender.render(table, cols, fields, db);
        db.closeConnection(); 
